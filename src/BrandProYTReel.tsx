/**
 * BrandProYTReel — scaffolded by ReelStack v1.4
 *
 * Family:    glass
 * Preset:    graphify
 * Source:    reference/glass/graphify.tsx
 * Cloned at: 2026-05-31T14:20:31.837Z
 *
 * This file is a faithful clone of the production GraphifyReel
 ...
 *   4. Run `/reelstack-lint src/BrandProYTReel.tsx` and address any errors.
 */
...
// Script: "Most business owners know the drill…"
// ═══════════════════════════════════════════════════════════════
export const BRANDPRO_TOTAL = 1625;

export const BEATS = {
  // ── Hook: "Most business owners know the drill…"
  hook:         0,    // 0.0s  — scene open
  drill:        81,   // 2.7s  — "…know the drill,"
  consistently: 137,  // 4.6s  — "post consistently,"
  professional: 237,  // 7.9s  — "look professional,"

  // ── Pain: "but in reality…"
  pain:         237,  // 7.9s  — scene cut
  reality:      279,  // 9.3s  — "in reality,"
  time:         290,  // 9.7s  — "never enough time"
  designer:     327,  // 10.9s — "not a designer,"
  inconsistent: 406,  // 13.5s — "looks inconsistent."
  brandWeak:    452,  // 15.1s — "brand feels weak"
  customers:    529,  // 17.6s — "fails to turn visitors into customers."

  // ── Judge: "People will judge…"
  judge:        529,  // 17.6s — scene cut
  seconds:      584,  // 19.5s — "in seconds"
  word:         634,  // 21.2s — "before they even read the word."

  // ── Agitate: "You're confusing…"
  agitate:      634,  // 21.2s — scene cut
  confusing:    702,  // 23.4s — "You're confusing."
  trust:        755,  // 25.2s — "lose trust instantly."

  // ── Pivot: "That's the specific problem…"
  pivot:        755,  // 25.2s — scene cut
  solve:        841,  // 28.1s — "that I solve."

  // ── Solve: "I create the clean social media design…"
  create:       841,  // 28.1s — scene cut
  solveBlock1:  1045, // 34.8s — "…trustworthy and professional online."
  struggling:   1045, // 34.8s — "Instead of struggling…"
  focus:        1233, // 41.1s — "Focus on running your business."

  // ── CTA: "If you're ready…"
  cta:          1233, // 41.1s — scene cut
  handle:       1355, // 45.2s — "I handle the entire visual side,"
  firstImpression: 1388, // 46.3s — "your first impression"
  serious:      1437, // 47.9s — "serious customers."
  ready:        1437, // 47.9s — "If you're ready…"
  sendMessage:  1570, // 52.4s — "send me a message"
  end:          1625, // 54.1s
} as const;
  end: 1956, // 65.2s
} as const;
